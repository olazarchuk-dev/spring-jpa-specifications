...
public class Application {
    ...
    public CommandLineRunner specificationsDemo(MovieRepository movieRepository) {
        return args -> {
            ...
            System.out.println("\n2.  search movies by `title` and `rating` > 7");
            ...
            System.out.println("\n3.  search movies by release year < 2010 and rating > 8");
            ...
            System.out.println("\n4.  search movies by watch time >= 150 and sort by `title`");
            ...
            System.out.println("\n5.  search movies by title <> 'white' and paginate results");
